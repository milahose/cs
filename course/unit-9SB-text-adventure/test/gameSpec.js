...
describe('asks questions to the user', () => {
  ...
  xit('lets a user start a game by typing \'yes\' at prompt', (done) => {
    proc.stdout.once('data', (dataOutput) => {
  ...
  xit('asks a user to pick a favorite programming language by pressing \'1\' at prompt', (done) => {
  ...
  xit('the user can pick javascript! by pressing \'1\' at the prompt', (done) => {
    proc.stdout.once('data', () => {
      proc.stdin.write('yes\r');
      proc.stdout.once('data', () => {
        proc.stdout.once('data', () => {
  ...
  xit('the user can enter js that evals to 42 as a sum', (done) => {
    proc.stdout.once('data', (data) => {
      proc.stdin.write('yes\r');
      proc.stdout.once('data', () => {
        proc.stdout.once('data', (data) => {
  ...
  xit('the user can enter js that evals to 42 as multiply', (done) => {
    proc.stdout.once('data', (data) => {
      proc.stdin.write('yes\r');
      proc.stdout.once('data', () => {
        proc.stdout.once('data', (data) => {
